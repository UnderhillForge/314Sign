...
sudo chmod 664 "$WEB_ROOT/login/index.html" 2>/dev/null || true
sudo chmod 664 "$WEB_ROOT/remotes/index.html" 2>/dev/null || true
sudo chmod 664 "$WEB_ROOT/debug/index.html" 2>/dev/null || true
