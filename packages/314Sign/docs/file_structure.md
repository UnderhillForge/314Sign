...
├── edit/                   # Menu editing UI
├── design/                 # Design customization UI
├── rules/                  # Schedule rules UI
├── slideshows/             # Slideshow editor UI
...
```
rules/
├── examples/             # (empty - examples moved to docs comments)
...
2. **Frontend**: Update HTML in root UI folders (edit/, design/, rules/, etc.)
