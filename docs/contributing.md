...
- Help real-world kitchens, clubs, and cafes go digital  
- Learn Raspberry Pi, lighttpd, PHP, and kiosk mode  
- Make a tool used by **actual people** (not just devs)  
- Get your name in the **Hall of Fame** below  
...
- What happened
- What you expected
- Screenshot or phone model (optional but *very* helpful)
...
- Dark mode toggle
- QR code generator in the editor
- Multi-language support
- Google Sheets sync

---

### 3. **Fix Something or Add a Feature**
...
# 3. Make your changes
# Test on a real Raspberry Pi if possible!
